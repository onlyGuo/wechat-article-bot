...
| Article Skills | Preview read-only built-in HTML examples loaded from packaged classpath resources, or create and maintain custom database-backed Skills whose examples are generated by the configured LLM after every save. |
